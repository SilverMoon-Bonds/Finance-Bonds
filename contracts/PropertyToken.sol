...
// 0x19608491943e9B4257617AA55ceed67837A4557D
contract PropertyToken is ERC3475 {
    ...
    constructor() {      
        ...
        _classes[1]._values["symbol"].stringValue = "3475 Moonbeam Rd. Lot# 124, Miami, FL 33101, US - Lot #124";
        _classes[1]._values["category"].stringValue = "property";
        _classes[1]._values["subcategory"].stringValue = "Loft Townhouse";
        ...
        _classes[1]._values["propertyLocation"].stringValue = "Don Marcos Villa 34, Bogota, Colombia";
